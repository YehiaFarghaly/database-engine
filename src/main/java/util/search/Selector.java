...
public class Selector {
	...
	public static Iterator selectWithIndex(SQLTerm[] terms, String[] opr,
			HashMap<OctreeIndex<?>, ArrayList<Integer>> indIdx) throws DBAppException {
		...
		for (Map.Entry<OctreeIndex<?>, ArrayList<Integer>> curr : indIdx.entrySet()) {
			...
			List<Object> pages = curr.getKey().query(octreeBounds, 0, 0);
			Vector<Vector<Tuple>> result = new Vector<>();
